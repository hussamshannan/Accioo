...
export default function CallBanner() {
  ...
  return (
    <div
      className="fixed top-3 left-1/2 -translate-x-1/2 z-50 max-w-[600px] w-[92%] rounded-full bg-primary px-4 py-2 flex items-center gap-3 cursor-pointer shadow-lg"
      onClick={(e) => {
    ...
    >
      ...
      <span className="text-primary-foreground text-sm font-medium truncate flex-1">
